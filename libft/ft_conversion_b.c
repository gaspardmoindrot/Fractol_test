...
{
	if (p_l.l == 1)
		p_l = ft_cl_print_b(va_arg(p_l.ap, unsigned long), p_l);
	else if (p_l.l == 2)
		p_l = ft_cl_print_b((unsigned long)va_arg(p_l.ap, unsigned long long), p_l);
	else if (p_l.h == 1)
		p_l = ft_cl_print_sh_b((unsigned long)va_arg(p_l.ap, unsigned int), p_l);
	else if (p_l.h == 2)
		p_l = ft_cl_print_ch_b((unsigned long)va_arg(p_l.ap, unsigned int), p_l);
	else
		p_l = ft_cl_print_in_b((unsigned long)va_arg(p_l.ap, unsigned int), p_l);
	return (p_l);
}
